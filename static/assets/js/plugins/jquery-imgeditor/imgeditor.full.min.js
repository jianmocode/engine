...
exports.interact=fa):"function"==typeof define&&define.amd?define("interact",function(){return fa}):a.interact=fa}}("undefined"==typeof window?void 0:window),jQuery.fn.imgeditor=function(a,b){function c(a,b){var c=new e(a,b);c.canvasInit().panelInit().helperInit();var d=c.get("ready");return"function"==typeof d&&d(c),c.updatePage({id:c.get("id"),index:c.get("index"),title:c.get("title"),bgimage:c.get("bgimage"),bgcolor:c.get("bgcolor")},function(){c.setId(c.get("id")),c.setIndex(c.get("index"));var a=c.get("items");for(var b in a){var d=a[b];debug.info("load item :",d[0],d[1],d[2]);try{$imgeditor.add(d[0],d[1],d[2])}catch(e){debug.info("load items error =",e)}}c.get("disabled")===!0&&c.disabled();var f=c.get("load");"function"==typeof f&&f(c)},"init"),c}function d(a){var b=this;this.$em=$(a),this.events={load:function(a){},show:function(){},hide:function(){},update:function(a,b){},remove:function(a,b){},"upload.click":function(a,b){}},$(".fn-update",this.$em).click(function(a){b.events.update(a,$("input[data-name=id]",b.$em).val(),b.serializeArray())}),$(".fn-remove",this.$em).click(function(a){b.events.remove(a,$("input[data-name=id]",b.$em).val())}),$(".fn-upload",this.$em).click(function(a){b.events["upload.click"](a,$("input[data-name=id]",b.$em).val())}),$(".fn-save",this.$em).click(function(a){b.events["save.click"](a,$("input[data-name=id]",b.$em).val(),b.serializeArray())}),this.load=function(a,c,d){c=c||{},d=d||{},"object"==typeof a&&null!=a&&(d=c||{},c=a,a=null),$form=$("form",b.$em),"undefined"!=typeof a&&null!=a&&(0==$("input[data-name=id]",b.$em).length?$form.append('<input type="hidden" data-name="id" value="'+a+'" />'):$("input[data-name=id]",b.$em).val(a));for(var e in c)$input=$("[name="+e+"]",$form),0!=$input.length&&("INPUT"==$input.prop("tagName")&&"text"==$input.attr("type")?$input.parent().hasClass("js-colorpicker")?$input.parent().colorpicker("setValue",c[e]):$input.val(c[e]):"TEXTAREA"==$input.prop("tagName")?$input.val(c[e]):"SELECT"==$input.prop("tagName")&&$input.val(c[e]).trigger("change"));for(var e in d)$input=$("[name="+e+"]",$form),0!=$input.length&&"INPUT"==$input.prop("tagName")&&"text"==$input.attr("type")&&$input.val(d[e]);return b.events.load(a,c,d),b},this.show=function(){return b.$em.removeClass("hidden").show(),b.events.show(),b},this.hide=function(){return b.$em.addClass("hidden").hide(),b.events.hide(),b},this.on=function(a,c){"function"==typeof c&&(b.events[a]=c)},this.serializeArray=function(){function a(a,b,c){"[]"==a.slice(-2)?(a=a.slice(0,-2),"undefined"==typeof b[a]&&(b[a]=[]),b[a].push(c)):b[a]=c}$form=b.$em.children("form");var c={};return $.each($form.serializeArray(),function(b,d){var e=d.name;$('select[name="'+e+'"]',$form).hasClass("js-select2")?a(e,c,$('select[name="'+e+'"]',$form).val()):a(e,c,d.value)}),c}}function e(a,b){var c=this,e={disabled:!1,action:null,toolbar:null,api:{text:null,qrcode:null},helper:{em:$(".imgeditor-helper")},panel:{image:$(".imgeditor-panels  .image"),text:$(".imgeditor-panels .text"),qrcode:$(".imgeditor-panels .qrcode"),page:$(".imgeditor-panels .qrcode")},canvas:{width:"auto",height:"auto"},id:null,index:null,bgimage:"",bgcolor:"rgba(255,255,255,0)",title:"未命名",zoom:1,action:null,items:[],ready:function(){},load:function(){}};this.option=$.extend({},e,b),this.id=null,this.index=null,this.$em=a,this.$canvas=null,this.$helper=null,this.$panels={image:null,text:null,qrcode:null,page:null},this.$toolbar=this.option.toolbar,this.items={},this.selected=null,this.page={id:null,index:null,title:null,bgimage:null,origin:null,bgcolor:"rgba(255,255,255,0)"},this.events={zoom:function(a){},import:function(a){},load:function(a){}},this.flag={draggable:!0,resizeable:!0,locked:!1};var f=function(){return id=Date.parse(new Date)+parseInt(1e4*Math.random()),id},g=function(a,b,d,e){if(0!=c.flag.draggable){var f=$(a);x=(parseFloat(f.attr("data-x"))||0)+b,y=(parseFloat(f.attr("data-y"))||0)+d,f.css("transform","translate("+x+"px, "+y+"px)"),f.css("webkitTransform","translate("+x+"px, "+y+"px)"),f.attr("data-x",x),f.attr("data-y",y)}},h=function(a,b,d,e){if(e="move",0!=c.flag.draggable){x=(parseFloat(a.getAttribute("data-x"))||0)+b,y=(parseFloat(a.getAttribute("data-y"))||0)+d,a.style.webkitTransform=a.style.transform="translate("+x+"px, "+y+"px)",a.setAttribute("data-x",x),a.setAttribute("data-y",y);var f=a.getAttribute("data-id")||null;null!=f&&"undefined"!=typeof c.items[f]&&c.update(f,{},{x:parseInt(x/c.zoom()),y:parseInt(y/c.zoom())},e)}},i=function(a,b,d,e,f){if(f="resize",0!=c.flag.resizeable){e=e||1,x=parseFloat(a.getAttribute("data-x"))||0,y=parseFloat(a.getAttribute("data-y"))||0,a.style.width=b+"px",a.style.height=d+"px",a.style.webkitTransform=a.style.transform="translate("+x+"px,"+y+"px)",a.setAttribute("data-x",x),a.setAttribute("data-y",y),a.setAttribute("data-width",b/e),a.setAttribute("data-height",d/e);var g=a.getAttribute("data-id")||null;null!=g&&"undefined"!=typeof c.items[g]&&c.update(g,{width:parseInt(b/e),height:parseInt(d/e)},{x:parseInt(x/e),y:parseInt(y/e)},f)}},j={width:!0,height:!0,origin:!0,text:!0,font:!0,size:!0,color:!0,background:!0,align:!0,valign:!0,type:!0,dir:!0,line:!0,space:!0},k={width:!0,height:!0,origin:!0,text:!0,params:!0,logo:!0,logowidth:!0,color:!0,background:!0,type:!0,config:!0,appid:!0,secret:!0};this.canvasInit=function(){c.$em.css("margin",0).css("padding",0).css("overflow","hidden");var a=c.option.canvas.width,b=c.option.canvas.height;if("auto"==a)a=c.$em.width();else if("screen"==a){var d=c.option.canvas.offsetX||0,e=$(window).width();a=e-d}if("auto"==b)b=c.$em.height();else if("screen"==b){var f=c.option.canvas.offsetY||0,g=$(window).height();b=g-f}return c.$em.css("width",a).css("height",b).css("background","#ccc").css("background-image","linear-gradient(white 2px,transparent 0),linear-gradient(90deg, white 2px,transparent 0),linear-gradient(hsla(0,0%,100%,.3) 1px,transparent 0),linear-gradient(90deg,hsla(0,0%,100%,.3) 1px,transparent 0)").css("background-size","75px 75px,75px 75px,15px 15px,15px 15px"),1!=c.$em.data("init")&&(c.$em.data("init",1),c.$em.click(function(a){c.deselect(c.selected,"user"),c.panelShow("page",{},{},"user")}),c.$em.mousedown(function(a){c.panelHide("user")}),c.$em.mouseup(function(a){c.panelToggle("user")})),c},this.helperInit=function(){return 0==this.option.helper.em.length?c:(c.$helper=c.option.helper.em,c.$helper.css("margin",0).css("padding",0).css("overflow","hidden").css("width",c.$em.width()).css("height",c.$em.height()).attr("data-height",c.$em.height()).attr("data-width",c.$em.width()),c)},this.open=function(a,b,d){if(null!=c.$helper){b=b||{},d=d||function(){};var e=c.option.helper.pages||{};if("string"==typeof e[a]){var f=$.extend({id:c.getId(),index:c.getIndex()},b||{});c.$helper.load(e[a],f,d)}else if("object"==typeof e[a]){var g=e[a].url||null,f=$.extend({id:c.getId(),index:c.getIndex()},e[a].query||{},b);c.$helper.load(g,f,d)}}},this.disabled=function(){if(!($(".mask",c.$em).length>=1)){var a=0;null!=c.$toolbar&&(a=c.$toolbar.outerHeight());var b=$('<div class="mask" style="position:absolute;background:rgba(0,0,0,0.3);z-index:1030;top:0px;width:'+c.$em.outerWidth()+"px;height:"+(c.$em.outerHeight()+a)+'px;"></div>');b.click(function(a){a.stopPropagation()}),b.mouseup(function(a){a.stopPropagation()}),b.mousedown(function(a){a.stopPropagation()}),c.$em.append(b)}},this.enabled=function(){$(".mask",c.$em).remove()},this.min=function(){var a=c.$em.parent();if(a.is($("[class*='col-']"))?a.removeClass(function(b,c){var d=c.match(/(^|\s)col-\S+/g)||[];for(var e in d)null==a.attr("data-col")&&a.attr("data-col",d[e]),a.attr("data-border-left",a.css("border-left")),a.attr("data-border-right",a.css("border-right"));return d.join(" ")}).addClass("col-zero").addClass("hidden"):c.$em.addClass("hidden"),null!=c.$helper){var b=c.$helper.parent().parent();b.removeClass(function(a,c){var d=c.match(/(^|\s)col-\S+/g)||[];for(var e in d)null==b.attr("data-col")&&b.attr("data-col",d[e]);return d.join(" ")}).addClass("col-xs-12").removeClass("hidden")}},this.normal=function(){var a=c.$em.parent();if(a.is($("[class*='col-']"))?a.removeClass(function(b,c){var d=c.match(/(^|\s)col-\S+/g)||[];return null==a.attr("data-col")&&a.attr("data-col",d[0]),d.join(" ")}).addClass(a.attr("data-col")).removeClass("hidden"):c.$em.removeClass("hidden"),null!=c.$helper){var b=c.$helper.parent().parent();b.removeClass(function(a,c){var d=c.match(/(^|\s)col-\S+/g)||[];return null==b.attr("data-col")&&b.attr("data-col",d[0]),d.join(" ")}).addClass(b.attr("data-col")),b.removeClass("hidden")}},this.max=function(){var a=c.$em.parent();if(a.is($("[class*='col-']"))?(a.removeClass(function(b,c){var d=c.match(/(^|\s)col-\S+/g)||[];for(var e in d)null==a.attr("data-col")&&a.attr("data-col",d[e]),a.attr("data-border-left",a.css("border-left")),a.attr("data-border-right",a.css("border-right"));return d.join(" ")}).addClass("col-xs-12").removeClass("hidden"),a.css("border-right","none"),a.css("border-left","none")):c.$em.removeClass("hidden"),null!=c.$helper){var b=c.$helper.parent().parent();b.removeClass(function(a,c){var d=c.match(/(^|\s)col-\S+/g)||[];for(var e in d)null==b.attr("data-col")&&b.attr("data-col",d[e]);return d.join(" ")}).addClass("col-zero").addClass("hidden")}},this.panelInit=function(){var a=this.option.panel;for(var b in a)if("object"==typeof a[b]&&a[b].length>0){var e=a[b].clone();e.attr("data-panel",b).css("position","absolute").css("z-index",1029).css("border-top","1px solid #e9e9e9").css("background","#f5f5f5").css("box-shadow","0 0 12px rgba(0, 0, 0, 0.1)").css("-webkit-box-shadow","0 0 12px rgba(0, 0, 0, 0.1)").css("width","100%").css("bottom","0px").addClass("option-panel").addClass("hidden").hide(),e.click(function(a){if($(".colorpicker").hasClass("colorpicker-visible")===!0)try{$(".js-colorpicker").colorpicker("hide")}catch(b){}a.stopPropagation()}),$(".js-colorpicker",e).click(function(a){a.stopPropagation()}),e.mousedown(function(a){a.stopPropagation()}),e.mouseup(function(a){a.stopPropagation()}),c.$em.append(e),c.$panels[b]=new d(e),c.$panels[b].on("update",function(a,b,d){var e=c.items[b]||{},f=e.name||"page",g={};return"undefined"!=typeof d.x&&(g.x=d.x,delete d.x),"undefined"!=typeof d.y&&(g.y=d.y,delete d.y),"page"==f?(c.updatePage(d,null,"panel"),void("function"==typeof c.events["page.update"]&&c.events["page.update"](a,d))):(c.update(b,d,g,"panel"),void("function"==typeof c.events[f+".update"]&&c.events[f+".update"](a,b,d,g)))}),c.$panels[b].on("remove",function(a,d){c.remove(d,"user"),"function"==typeof c.events[b+".remove"]&&c.events[b+".remove"](a,d)}),c.$panels[b].on("upload.click",function(a,b){var d=c.items[b]||{},e=d.name||"page";"function"==typeof c.events[e+".upload.click"]&&c.events[e+".upload.click"](a,b)}),c.$panels[b].on("save.click",function(a,b,d){var e=c.items[b]||{},f=e.name||"page",g="",h={};"undefined"!=typeof d.x&&(h.x=d.x,delete d.x),"undefined"!=typeof d.y&&(h.y=d.y,delete d.y),"page"==f?(c.updatePage(d,null,"panel"),"function"==typeof c.events["page.update"]&&c.events["page.update"](a,d)):(c.update(b,d,h,"panel"),"function"==typeof c.events[f+".update"]&&c.events[f+".update"](a,b,d,h)),"function"==typeof c.events.save&&(g=c.events.save(a,b)),"function"!=typeof g&&(g=function(a,b){}),c.save(g)})}return c},this.panelToggle=function(a){if("init"==a||"silent"==a)return c;var b=!1;for(var d in c.$panels)null!=c.$panels[d]&&0==c.$panels[d].$em.is(":hidden")&&(b=d);if(b!==!1)return c.$panels[b].hide(),c;var e={id:null,name:"page"};return null!=this.selected&&(e=this.items[this.selected]),null!=c.$panels[e.name]&&c.$panels[e.name].show(),c},this.panelShow=function(a,b,d,e){if(b=b||{},d=d||{},void 0==typeof c.items[a]&&"page"!==a)return c;var f="";if(f="page"==a?a:c.items[a].name,"undefined"==typeof c.$panels[f]||null==c.$panels[f])return c;if("page"!=a){var g=c.items[a].option||{},h=c.items[a].params||{},i=c.items[a].pos||{};b=$.extend(g,h,b),d=$.extend(i,d),c.update(a,b,d,"silent")}return"init"==e||"silent"==e?c:(c.panelHide(e),c.$panels[f].show(),c)},this.panelHide=function(a){if("init"==a||"silent"==a)return c;for(var b in c.$panels)null!=c.$panels[b]&&c.$panels[b].hide();return c},this.background=function(a,b,d){if(a=a||null,b=b||null,d=d||function(){},null==a&&null==b)return c.option.bgimage;if("color"==a&&null==b)return c.option.bgcolor;c.set("bgimage",a),null!=b&&c.set("bgcolor",b);var e=c.$em.children(".imgeditor-background");e.children(".imgeditor-background-image").remove(),0==e.length&&(e=$('<div class="imgeditor-background" style="position:relative;visibility:hidden"></div>'),e.css("width","auto").css("height","auto"),c.$em.append(e)),null!=b&&(e.css("background",b),c.page.bgcolor=b),e.css("visibility","hidden");var f=function(b,f){e.width(b),e.height(f);var h=100/b,i=100/f;e.attr("data-width",b),e.attr("data-height",f),e.attr("data-offsetx",h),e.attr("data-offsety",i),e.attr("data-x",0),e.attr("data-y",0),c.$canvas=e;var j=c.getBGPerfectPos(e.attr("data-width"),e.attr("data-height"));g(e,j.x,j.y),c.zoom(j.zoom),interact(".imgeditor-background").draggable({autoScroll:!0,inertia:!0,restrict:{restriction:"parent",endOnly:!0,elementRect:{top:1-i,left:1-h,bottom:i,right:h}},onmove:function(a){g(a.target,a.dx,a.dy)}}),c.move(),c.page.bgimage=a,d(),e.css("visibility","visible")};return null==a?(f(c.$em.width()-80,c.$em.height()-80),c):(e.append('<img class="imgeditor-background-image ">'),e.children(".imgeditor-background-image").attr("src",a),e.children(".imgeditor-background-image").on("error",function(a){f(c.$em.width()-80,c.$em.height()-80),$(this).addClass("hidden")}),e.children(".imgeditor-background-image").on("load",function(a){f($(this).width(),$(this).height()),$(this).removeClass("hidden")}),c)},this.getBGPerfectPos=function(a,b,d){d=d||40;var e=c.$em.width()-2*d,f=c.$em.height()-2*d;if(a=parseInt(a),b=parseInt(b),a>b){var g=f/b;g=g-g%.05+.05;var h=a*g,i=parseInt(parseFloat((c.$em.width()-h)/2).toFixed(0));return i<40&&(i=40),{zoom:g,x:parseInt(i),y:40}}var g=e/a;g=g-g%.05+.05;var h=a*g,i=parseFloat((c.$em.width()-h)/2).toFixed(0);return{zoom:g,x:parseInt(i),y:40}},this.getItemPerfectPos=function(a,b){a=parseInt(a),b=parseInt(b);var d=(c.$em.width(),c.$em.height(),this.zoom()),e=(parseFloat(c.$canvas.attr("data-width")),parseFloat(c.$canvas.attr("data-height")),parseFloat(c.$canvas.attr("data-x"))||0),f=parseFloat(c.$canvas.attr("data-y"))||0,g=e/d*-1,h=f/d*-1,i=100/d,j=100/d;return{x:g+i,y:h+j}},this.zoom=function(a){if(null!=this.$canvas){if(a=a||null,null==a)return c.option.zoom;var b=c.option.zoom;c.set("zoom",a);var d=c.$canvas.attr("data-width")*a,e=c.$canvas.attr("data-height")*a;c.$canvas.width(d),c.$canvas.height(e),c.$canvas.children(".imgeditor-background-image").width(d),c.$canvas.children(".imgeditor-background-image").height(e);return $(".imgeditor-item").each(function(c,d){var e=($(d).width(),$(d).height(),$(d).attr("data-width")*a),f=$(d).attr("data-height")*a;$(d).width(e),$(d).height(f);var g=parseFloat($(d).attr("data-x")),h=parseFloat($(d).attr("data-y")),i=g/b*a,j=h/b*a;$(d).attr("data-x",i),$(d).attr("data-y",j),$(d).css("transform","translate("+i+"px,"+j+"px)"),$(d).css("-webkit-transform","translate("+i+"px,"+j+"px)")}),"function"==typeof c.events.zoom&&c.events.zoom(a),c}},this.select=function(a,b){if(c.selected!=a||"init"!=b&&"silent"!=b){var d=c.selected;return c.deselect(d,b),"init"!=b&&"silent"!=b&&$("[data-id="+a+"]").children(".title").removeClass("hidden").show(),c.selected=a,c.panelShow(a,{},{},b),c}},this.deselect=function(a,b){return"undefined"==typeof a||null==a?c:("init"!=b&&"silent"!=b&&$("[data-id="+a+"]").children(".title").addClass("hidden").hide(),c.selected=null,c.panelHide(b),c)},this.clean=function(a){if(a=a||"user",!c.islocked()){c.lock();for(var b in c.items){var d="#item-"+b;$item=$(d,c.$canvas),$item.remove(),delete c.items[b]}return c.panelShow("page",{},{},a),c.unlock(),c}},this.updatePage=function(a,b,d){d=d||"silent",b=b||function(){},c.page=$.extend(c.page,a),debug.log(" updatePage","source=",d,"data=",a," that.page=",c.page),bgcolor=a.bgcolor||null,bgimage=a.bgimage||null,null==bgcolor&&null==bgimage||c.background(bgimage,bgcolor,b),null!=c.$panels.page&&(c.$panels.page.load(null,c.page),"init"!=d&&"silent"!=d&&c.$panels.page.show())},this.save=function(a){if(null==c.option.action)return void console.log("未设定数据服务器");var b=c.option.action,d=c.getData();$.ajax({url:b,type:"POST",dataType:"json",contentType:"application/json",processData:!1,data:JSON.stringify(d)}).done(function(b,d,e){return"undefined"!=typeof b.code&&"undefined"!=typeof b.message&&0!=b.code?(c.$em.trigger("status-change",["error"]),void a(b,"error",e)):(debug.info("mark needsave =",!1),c.needsave=!1,c.$em.trigger("status-change",["saved"]),c.setId(b.page.id),void a(b,"success",e))}).fail(function(b,d,e){c.$em.trigger("status-change",["error"]),a({code:500,message:e},"error",b)})},this.unlock=function(){c.flag.locked=!1},this.lock=function(){c.flag.locked=!0},this.islocked=function(){return c.flag.locked},this.getId=function(){return null==c.id&&c.setId(f()),c.id},this.getIndex=function(){return null==c.index&&c.setIndex(0),c.index},this.setIndex=function(a){null==a||void 0==a?(c.index=null,c.option.index=null,c.page.index=null,c.$em.attr("data-param-index","")):(c.index=c.option.index=c.page.index=a,c.$em.attr("data-param-index",a))},this.setId=function(a){null==a||void 0==a?(c.id=null,c.option.id=null,c.page.id=null,c.$em.attr("data-param-id","")):(c.id=c.option.id=c.page.id=a,debug.log("setId","       that.id=",c.id," that.option.id=",c.option.id," that.page['id']=",c.page.id," id=",a),c.$em.attr("data-param-id",a))},this.getData=function(){var a={page:c.page,items:c.items};return a},this.add=function(a,b,d,e,g){e=e||"silent",g=g||function(){};var h=f();if("image"==a)c.items[h]={name:a,option:b,pos:d},c.addImage(h,b,d,null,e,g);else if("text"==a){if(null==c.option.api.text)return void console.log("未设定字体服务器");"undefined"==typeof b.preserveAspectRatio&&(b.preserveAspectRatio=!1);var i={width:b.width||260,height:b.height||36,text:b.text||"",font:b.font||1,size:b.size||24,color:b.color||"rgba(0,0,0,1)",background:b.background||"rgba(255,255,255,0)",align:b.align||"center",valign:b.valign||"top",type:b.type||"horizontal",dir:b.dir||"ltr",line:b.line||1.2,space:b.space||.2};b.src=c.option.api.text+"?"+$.param(i),b.resizeend=function(a,b,d){b=b||{};var e=a.target,f=$.extend({},c.items[h].params);for(var g in b)1==j[g]&&(f[g]=b[g]);f.width=e.getAttribute("data-width"),f.height=e.getAttribute("data-height");var i=e.getAttribute("id"),k=c.option.api.text+"?"+$.param(f);$("#"+i).children("img").attr("src",k),c.items[h].params=f},c.items[h]={name:a,option:b,pos:d,params:i},this.addImage(h,b,d,"文本",e,g)}else if("qrcode"==a){if(null==c.option.api.qrcode)return console.log("未设定二维码生成服务器"),h;b.height=b.width,b.preserveAspectRatio=!0;var i={text:b.text||"",width:b.width||300,height:b.width||300,logo:b.logo||"",logowidth:b.logowidth||50,color:b.color||"rgba(0,0,0,1)",background:b.background||"rgba(255,255,255,0)",type:b.type||"url",config:b.config||null,appid:b.appid||null,secret:b.secret||null};b.src=c.option.api.qrcode+"?"+$.param(i),b.resizeend=function(a,b,d){b=b||{};var e=a.target,f=$.extend({},c.items[h].params);for(var g in b)1==k[g]&&(f[g]=b[g]);f.width=e.getAttribute("data-width"),f.height=e.getAttribute("data-width");var i=e.getAttribute("id"),j=c.option.api.qrcode+"?"+$.param(f);$("#"+i).children("img").attr("src",j),c.items[h].params=f},c.items[h]={name:a,option:b,pos:d,params:i},this.addImage(h,b,d,"二维码",e,g)}return"function"==typeof c.events.add&&c.events.add(h,a,b,d,e),h},this.update=function(a,b,d,e,f){if("undefined"==typeof c.items[a])return c;f=f||function(){},e=e||"silent",b=b||{},d=d||{};var g=c.items[a].name,h=$.extend({},c.items[a]),i=$("#item-"+a,c.$canvas);if(c.items[a].pos=c.items[a].pos||{},"image"==g)c.updateImage(a,b,d,h,e,f),c.items[a]={name:g,option:$.extend(c.items[a].option,b),pos:$.extend(c.items[a].pos,d)},null!=c.$panels.image&&c.$panels.image.load(a,b,d);else if("text"==g){var l=$.extend({},c.items[a].params);for(var m in b)1==j[m]&&(l[m]=b[m]);1!=i.data("resizeing")&&(b.src=c.option.api.text+"?"+$.param(l)),c.updateImage(a,b,d,h,e,f),c.items[a]={name:g,params:l,option:$.extend(c.items[a].option,b),pos:$.extend(c.items[a].pos,d)},null!=c.$panels.text&&c.$panels.text.load(a,b,d)}else if("qrcode"==g){var l=$.extend({},c.items[a].params);"undefined"!=typeof b.width&&(b.height=b.width);for(var m in b)1==k[m]&&(l[m]=b[m]);1!=i.data("resizeing")&&(b.src=c.option.api.qrcode+"?"+$.param(l)),c.updateImage(a,b,d,h,e,f),c.items[a]={name:g,params:l,option:$.extend(c.items[a].option,b),pos:$.extend(c.items[a].pos,d)},null!=c.$panels.qrcode&&c.$panels.qrcode.load(a,b,d)}return"function"==typeof c.events.update&&c.events.update(a,g,b,d,e),c},this.remove=function(a,b){if("undefined"==typeof c.items[a])return c;b=b||"silent";var d="#item-"+a;c.deselect(a,b),$item=$(d,c.$canvas),$item.remove(),delete c.items[a];var e=0;for(var f in c.items){c.select(f,b),e=1;break}return 0===e&&c.panelShow("page",{},{},b),"function"==typeof c.events.remove&&c.events.remove(a,b),c},this.updateImage=function(a,b,d,e,f,g){if(!c.islocked()&&"undefined"!=typeof c.items[a]){g=g||function(){},f=f||"silent",b=b||{},d=d||{};var h="#item-"+a;$item=$(h,c.$canvas);for(var i in b)"resizeend"!=i&&$item.attr("data-"+i,b[i]);if("undefined"!=typeof b.src&&null!=b.src&&0!=b.src){var j=$("img",$item).attr("src");j!=b.src&&$("img",$item).attr("src",b.src)}var k=this.zoom();"undefined"!=typeof b.width&&$item.width(b.width*k),"undefined"!=typeof b.height&&$item.height(b.height*k),"undefined"!=typeof b.alpha&&$item.children(".image").css("opacity",b.alpha);var l=c.items[a].pos.x,m=c.items[a].pos.y;"undefined"!=typeof d.x&&(l=d.x*k,$item.attr("data-x",l),$item.css("transform","translate("+l+"px,"+m+"px)"),$item.css("-webkit-transform","translate("+l+"px,"+m+"px)")),"undefined"!=typeof d.y&&(m=d.y*k,$item.attr("data-y",m),$item.css("transform","translate("+l+"px,"+m+"px)"),$item.css("-webkit-transform","translate("+l+"px,"+m+"px)"))}},this.addImage=function(a,b,d,e,f,g){if(!c.islocked()&&"undefined"!=b.width){g=g||function(){},f=f||"silent",e=e||"图片",b.width=b.width||null,b.height=b.height||null,b.alpha=b.alpha||1,"undefined"==typeof b.preserveAspectRatio&&(b.preserveAspectRatio=!0);var j="item-"+a,k=$('<div id="'+j+'" class="imgeditor-item"  style="top:0px; left:0px;border:1px dashed #e9e9e9;position:absolute;" ><div class="title" style="top:-20px;position:absolute;" ><span class="label label-primary"> '+e+" #"+a+'</span></div><img class="image" src="'+b.src+'"  style="width:100%;height:100%;" ></div>');for(var l in b)"resizeend"!=l&&k.attr("data-"+l,b[l]);var m=function(l,m,n){l.addClass("hidden").hide().removeAttr("style"),l.css("width","100%").css("height","100%").removeClass("hidden").show(),b.width=b.width||m,b.height=b.height||m,d=d||{},"undefined"!=typeof d.x&&"undefined"!=typeof d.y||(d=c.getItemPerfectPos(b.width,b.height));var o=c.zoom(),p=b.width*o,q=b.height*o,r=parseFloat(d.x*o),s=parseFloat(d.y*o);if(1!=k.data("image-loaded"))k.width(p),k.height(q),k.children(".image").css("opacity",b.alpha),k.css("transform","translate("+r+"px,"+s+"px)"),k.css("-webkit-transform","translate("+r+"px,"+s+"px)"),k.attr("data-x",r),k.attr("data-y",s),k.attr("data-id",a),k.children(".title").hide(),c.$canvas.append(k),$("#"+j).click(function(a){c.select($(this).attr("data-id"),"user"),a.stopPropagation()}),interact("#"+j).draggable({autoScroll:!0,inertia:!0,restrict:{restriction:"parent",endOnly:!0,elementRect:{top:0,left:0,bottom:1,right:1}},onmove:function(a){h(a.target,a.dx,a.dy,f)}}).resizable({preserveAspectRatio:b.preserveAspectRatio,edges:{left:!1,right:!0,bottom:!0,top:!1}}).on("resizemove",function(a){k.data("resizeing",1),i(a.target,a.rect.width,a.rect.height,c.zoom(),f)}).on("resizeend",function(a){k.data("resizeing",0),"function"==typeof b.resizeend&&b.resizeend(a,b,c.zoom())}),c.update(a,{},{x:parseInt(d.x),y:parseInt(d.y)},f),k.data("image-loaded",1),c.select(a,f),g(a,f);else if("图片"==e){var t=k.attr("data-id")||null;if(null==t)return;var u=c.items[t]||null;if(null==u)return;var v=u.option.width||m,w=u.option.height||n,x=u.option.alpha||1,y=m,z=n;m>n?(y=v,z=parseInt(n/m*y)):(z=w,y=parseInt(m/n*z)),c.update(t,{width:y,height:z,alpha:x},f),g(a,f)}};$("img",k).on("error",function(a){var c=b.width||100,d=b.height||100;m($(this),c,d),k.css("background","#d26a5c"),$(this).addClass("hidden")}),$("img",k).on("load",function(a){k.css("background","");var b=this.width,c=this.height;m($(this),b,c)})}},this.move=function(){c.flag.draggable=!0},this.on=function(a,b){return"string"!=typeof a?c:"function"!=typeof b?c:(c.events[a]=b,c)},this.set=function(a,b){return"undefined"!=typeof b&&"undefined"!=typeof a&&(c.option[a]=b),this},this.get=function(a){if("undefined"!=typeof a)return c.option[a]}}if("get"===a){if(this.length>1){var f=[];return this.each(function(){f.push($(this).data("imgeditor"))}),f}return $(this).data("imgeditor")}this.each(function(){$(this).data("imgeditor",c($(this),a))})};
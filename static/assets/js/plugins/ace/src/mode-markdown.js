...
var MarkdownHighlightRules = function() {
    ...
    this.$rules["start"].unshift({
        ...
        token: "markup.title.num",
        regex : /^#{1}(?=\s*[^ #]|\s+#.)/,
        next: "header-title",
    },{ //H2
        token: "markup.subtitle.num",
        regex : /^#{2}(?=\s*[^ #]|\s+#.)/,
        next: "header-subtitle",
    },{ //H2
        token: "markup.thirdtitle.num",
        regex : /^#{3}(?=\s*[^ #]|\s+#.)/,
        next: "header-thirdtitle",
    }, {
    ...
    this.addRules({
        ...
        "quoteblock" : [ { // quote only escape on completely blank lines.
            token : "empty_line",
            regex : "^$",
            next  : "start"
        }, { // quote
            ...
            defaultToken : "quote" //do not use markup.quote to allow stling leading `>` differntly
        } ],

...
* 
* Homepage: https://github.com/NB-Dev/multi-select
*/
  ...
  MultiSelect.prototype = {
    ...
    init: function(){
      ...
      if ( that.options.cssClass == '' ) {
        that.options.cssClass = ms.attr('class');
      }
    ...
    'generateLisFromOption' : function(option, index, $container){
      ...
      // Support Icon
      var optionIcon = $option.attr('data-icon') || '';
          if ( optionIcon != '' ){
              optionIcon = '<i class="'+optionIcon+'"></i>';
          }
          
      var selectableLi = $('<li '+attributes+'>'+optionIcon+'<span>'+ that.escapeHTML($option.text())+'</span></li>'),  // Icon Support
    ...
    'sort': function(){
      ...
      if (that.options.sortable){
        ...
        that.$selectionUl.find('.ms-selected').each(function() {
          ...
          // console.log(' sort:', $(this).data('ms-value') );
        });
      }
    },

...
c.remove();}},_resetStyle:function(c){c.css({display:""});if(!a.support.opacity){if(typeof c[0].style.removeAttribute=='function'){c[0].style.removeAttribute("filter");}}},destroy:function(){var c=this.options;

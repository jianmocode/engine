...
var CoreTeamDefaultSetting = function() {
    ...
    var initValidationRegister = function(){
        jQuery('.js-validation-CoreTeamDefaultSetting').validate({
            ...
            submitHandler: function(form) {
            	...
            	App.blocks('#team_update_form', 'submit', {
                       ...
                       error: function( data, status ) {
                          //  App.notify( data.errmsg, 'fa fa-times','danger');
                            console.log( data );
                       },
...
$(function () {
    ...
    App.initHelpers('image-crop'); // Image Crop 

    // 初始化表单验证程序
    CoreTeamDefaultSetting.init();
